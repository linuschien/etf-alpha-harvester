...
本系統需求嚴格依據算力生命週期與隱私隔離邊界劃分為**三大系統全域模組**與**四大個人投組模組**（共計 27 條標準 User Stories）：
...
│   ├── US-G02-global-universe-ranking.md   # G-02：全域標的治理與多因子排名 (3 條 US)
...
| --- | --- | --- | --- | --- |
| **PRD 3.1** | G-01 數據基石 | **US-G01-01** | 台股 ETF 日行情自動採集 | 每日 15:30 自動存檔，保留近 504 根日 K |
...
| **PRD 3.1** | G-01 數據基石 | **US-G01-04** | 新上市 ETF 與除息行事曆採集 | 追蹤掛牌 2 年內 ETF 基本面與公開除息日程 |
| **PRD 3.1** | G-01 數據基石 | **US-G01-05** | 數據齊備性守門員驗證 | 缺收盤價或異常跳空時自動熔斷暫停 |
| **PRD 3.2** | G-02 標的治理 | **US-G02-01** | 三大資產層級硬約束全域過濾 | TER ≤ 0.45%、AUM > 100 億、無槓桿 |
| **PRD 3.2** | G-02 標的治理 | **US-G02-02** | 半年度全市場多因子客觀評分 | 6/30, 12/31 運算 MOM, Sharpe, Hurst, 定額排行 |
| **PRD 3.2** | G-02 標的治理 | **US-G02-03** | 新上市 ETF 孵化觀測池維護 | 2 年內新 ETF 展示與滿期轉正提示 |
