...
INSERT INTO data_feed_sync_watermark (id, feed_name, last_successful_sync_at, latest_record_date, records_synced_count, status, updated_at)
VALUES
    ('d0000001-0000-0000-0000-000000000001', 'TAIWAN_ETF_QUOTES', TIMESTAMP '2026-01-01 00:00:00', TIMESTAMP '2026-01-01 00:00:00', 0, 'INITIALIZED', CURRENT_TIMESTAMP),
    ('d0000001-0000-0000-0000-000000000002', 'GLOBAL_BENCHMARKS', TIMESTAMP '2026-01-01 00:00:00', TIMESTAMP '2026-01-01 00:00:00', 0, 'INITIALIZED', CURRENT_TIMESTAMP),
    ('d0000001-0000-0000-0000-000000000003', 'CNN_FEAR_GREED', TIMESTAMP '2026-01-01 00:00:00', TIMESTAMP '2026-01-01 00:00:00', 0, 'INITIALIZED', CURRENT_TIMESTAMP),
    ('d0000001-0000-0000-0000-000000000004', 'MACRO_YIELD_SNAPSHOT', TIMESTAMP '2026-01-01 00:00:00', TIMESTAMP '2026-01-01 00:00:00', 0, 'INITIALIZED', CURRENT_TIMESTAMP),
    ('d0000001-0000-0000-0000-000000000005', 'TWSE_DCA_RANKINGS', TIMESTAMP '2026-01-01 00:00:00', TIMESTAMP '2026-01-01 00:00:00', 0, 'INITIALIZED', CURRENT_TIMESTAMP),
    ('d0000001-0000-0000-0000-000000000006', 'TWSE_ETF_METADATA', TIMESTAMP '2026-01-01 00:00:00', TIMESTAMP '2026-01-01 00:00:00', 0, 'INITIALIZED', CURRENT_TIMESTAMP);
